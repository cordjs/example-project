...
var EmptyArguments, OptionsList, copyFile, countFiles, exec, exists, fs, fsExtra, hidden, options, optparse, outputPath, parseOptions, path, printLine, printWarn, publicDir, removeSource, sources, spawn, syncFile, syncFiles, targetDir, timeLog, unwatchDir, usage, util, wait, walk, watchDir, watchFile, _ref;
...
EmptyArguments = 'Usage: cordjs [options] path/to/public -- [args]';

OptionsList = [['-o', '--output [DIR]', 'set the output directory'], ['-h', '--help', 'display this help message'], ['-s', '--server', 'start server'], ['-w', '--watch', 'watch scripts for changes and rerun commands']];
