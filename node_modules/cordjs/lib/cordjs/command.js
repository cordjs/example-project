...
OptionsList = [['-d', '--dev', 'development mode - copy all files to the targetDir'], ['-h', '--help', 'display this help message'], ['-s', '--server', 'start server'], ['-w', '--watch', 'watch scripts for changes and rerun commands']];
